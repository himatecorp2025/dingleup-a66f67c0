-- Fix generate_full_database_export to use JSONB-based extraction (no RECORD attribute issues)
-- and keep an increased statement_timeout for large exports.
...
BEGIN
  ...
  LOOP
    ...
    -- Generate INSERT statements for all rows using JSON approach (no RECORD column access)
