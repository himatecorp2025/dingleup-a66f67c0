-- Fix claim_daily_winner_reward RPC to use correct source value
...
BEGIN
  ...
  v_idempotency_key := 'rank_reward:' || p_user_id || ':' || p_day_date;
  
  -- Credit gold via wallet_ledger (idempotent) - FIXED: use 'rank_reward' source
